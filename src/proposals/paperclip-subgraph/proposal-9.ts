...
async function submitProposal(actions: IZrxTreasury.ProposedActionStruct[], treasuryAddress: string) {
  ...
  **Receiving address:** Ethereum 0xA2b6590A6dC916fe317Dcab169a18a5B87A5c3d5; Arbitrum 0xc5A13251c01257404430952481ACb8C0D6ed171D
  ...
  await tx.wait();
  // proposal: tx: 0xddc131a7876c90079d4a61f31949666e6d57218d57c59a4b654a5b11a4e21142
  // execution: tx: 0x60f3e458056ce86bb4806c5dd50a270d61e2391ff86a123a766ca85a36c54d08
  // arbi token bridge: tx: 0x97073ef0fa8c37e5d176f16ef460e8ccf52195ed5fcd76bc314f2f43a0c7de96
}
