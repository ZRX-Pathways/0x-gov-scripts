...
async function main() {
  ...
  const grantAmount = ethers.utils.parseEther("481369");
  const description = `# Z-13 Optimistic Funding for 0x Improvement Proposals
  ...
  **Price reference:** $ZRX 30-day EMA as of 05/18/2024 = $0.519353 (https://www.tradingview.com/symbols/ZRXUSD/technicals/?exchange=COINBASE)
  ...
  **Receiving address:** 0xc6784343E4e2eDA2b785B78994c33734Aa4A09fe
  ...
  Send 481,369 $ZRX to 0xc6784343E4e2eDA2b785B78994c33734Aa4A09fe`;
